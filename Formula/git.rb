class Git < Formula
  ...
  # This is the important local change: use the safe curl formula here instead
  # of the upstream curl/OpenSSL setup.
  ...
  def install
    ...
    # This is the important local change: point Git at the safe curl build.
  ...
  test do
    ...
    assert_match(/Authentication Required|Not using SSL_VERIFY_PEER/, output)
  end
end
